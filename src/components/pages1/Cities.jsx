...
class Cities extends Component {
  ...
  render() {
    const content = this.state.cities.map((city) => {
      return (
        <City 
        name={city.name}
        image={city.image}
    ...
    return (
      ...
      <h1>Cities, towns and villages</h1>
      <p>You can get acquainted with the life and culture of the Kyrgyz people in the settlements located in different regions. In the country there are a few cities and large towns. They are the capital of the country and most of the regional centers. There you can see architectural masterpieces of the Soviet era and buildings of modern style as well. In an extraordinary way industrial zones, cultural facilities and residential communities are combined there. Villages located away from the city also have their advantages. They are situated in an ecologically clean regions where people are engaged in agriculture and still try to keep the traditions of the ancient times.</p>
      {content}
      </div>
    )
  }
